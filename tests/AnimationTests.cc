...
TEST ( AnimationTestGetPrevNextFrameTime ) {
	...
	animation.addFramePose ("frame_A", 0.f, zero_vec, zero_vec, zero_vec);
	animation.addFramePose ("frame_A", 1.f, zero_vec, zero_vec, zero_vec);
	animation.addFramePose ("frame_A", 2.f, zero_vec, zero_vec, zero_vec);

	animation.addFramePose ("frame_B", 1.5f, zero_vec, zero_vec, zero_vec);
